# Automated Snowflake View Deployment CI/CD with GitHub Actions 
...
Add or modify .sql files and commit/push your changes.
The pipeline will automatically execute:
First in DEV.
If DEV succeeds, then in QA.
After review, merge into main to trigger deployment to PRD.
Required Secrets
